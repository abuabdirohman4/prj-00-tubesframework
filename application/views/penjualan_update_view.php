                                ...
                                <form action="storecreate" method="POST" class="col s12">
                                    <div class="row">
                                        <div class="input-field col s12">
                                            ...
                                            <input type="text" value='<?php echo $row->id_pegawai ?>' name="id_penjualan" class="form-control"><span class="text-danger"><?=form_error('id_penjualan')?></span>
                                        </div>
                                    </div>
                                    <div id="tambah_field">
                                        ...
                                        <div class="row">
                                            <div class="input-field col l6">
                                                <input type="hidden" name="id_minum_src[]" value="<?php echo $v->id_minum ?>"/>
                                                <select style="display:block" class='form-control' id='id_minuman' name='id_minuman[]'>
                                        ...
                                        <div class="col s12">
                                            ...
                                            <select class='form-control' id='id_pegawai' name='id_pegawai'>
                                                ...
                                                foreach ($pegawai as $k => $v) {
                                                    $selected = $row->id_pegawai == $v->id_pegawai ? "selected" : "";
